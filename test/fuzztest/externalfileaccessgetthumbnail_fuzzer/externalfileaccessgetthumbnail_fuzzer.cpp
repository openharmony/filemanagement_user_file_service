 ...
 */
#include "externalfileaccessgetthumbnail_fuzzer.h"
...
void SetNativeToken()
{
    ...
    infoInstance.processName = "ExternalFileAccessGetThumbnailFuzzTest";
...
bool ExternalFileAccessGetThumbnailFuzzTest(std::unique_ptr<char[]> data, size_t size)
{
    SetNativeToken();
    // CMD_GET_THUMBNAIL
    uint32_t code = 15;
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::ExternalFileAccessGetThumbnailFuzzTest(move(str), size);
    return 0;
}
