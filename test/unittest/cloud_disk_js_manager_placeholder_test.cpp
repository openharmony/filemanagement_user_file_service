...
/**
 * @tc.number: user_file_service_cloud_disk_js_manager_placeholder_GetCloudDiskErrMsg_001
 ...
 * @tc.level Level 1
 */
HWTEST_F(CloudDiskJSManagerPlaceholderTest, CloudDiskJSManager_GetCloudDiskErrMsg_001, TestSize.Level1)
{
...
/**
 * @tc.number: user_file_service_cloud_disk_js_manager_placeholder_GetCloudDiskErrMsg_002
 * @tc.name: GetCloudDiskErrMsg
 ...
 * @tc.level Level 1
 */
HWTEST_F(CloudDiskJSManagerPlaceholderTest, CloudDiskJSManager_GetCloudDiskErrMsg_002, TestSize.Level1)
{
...
/**
 * @tc.number: user_file_service_cloud_disk_js_manager_placeholder_ConvertToCloudDiskApiErrCode_001
 ...
 * @tc.level Level 1
 */
HWTEST_F(CloudDiskJSManagerPlaceholderTest, CloudDiskJSManager_ConvertToCloudDiskApiErrCode_001, TestSize.Level1)
{
